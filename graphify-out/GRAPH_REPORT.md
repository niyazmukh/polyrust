# Graph Report - minimal_rust  (2026-05-13)

## Corpus Check
- 20 files · ~26,102 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 438 nodes · 826 edges · 18 communities (17 shown, 1 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 76 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e73b8c73`
...
- `canonical_buy_target_for_notional()` --calls--> `ceil_to_multiple()`  [INFERRED]
  orders.rs → types.rs
- `derive_api_credentials()` --calls--> `derive_address()`  [INFERRED]
  auth.rs → signing.rs
- `derive_api_credentials()` --calls--> `address_lower_hex()`  [INFERRED]
  auth.rs → signing.rs
...
Cohesion: 0.17
Nodes (17): address_to_uint256_be(), clob_auth_struct_hash(), compute_clob_auth_domain(), decode_secret_b64_padded(), derive_api_credentials(), DerivedCredentials, L2AuthSigner, L2Headers (+9 more)

### Community 7 - "Community 7"
Cohesion: 0.11
Nodes (10): BuySubmitPolicy, on_binance_sample(), plan_sell_at_bid(), prepare_buy_submit(), PreparedBuySubmit, PreparedSellSubmit, record_buy_submit_outcome(), RuntimeCore (+2 more)
...
- **Why does `main()` connect `Community 3` to `Community 0`, `Community 2`, `Community 5`, `Community 6`, `Community 7`, `Community 14`?**
  _High betweenness centrality (0.253) - this node is a cross-community bridge._
- **Why does `SharesAtoms` connect `Community 2` to `Community 1`, `Community 3`, `Community 9`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `RuntimeCore` connect `Community 7` to `Community 11`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Are the 14 inferred relationships involving `main()` (e.g. with `init_background_logger()` and `load_env_file()`) actually correct?**
